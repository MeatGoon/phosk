...
<script language="javascript">
	function showmenueditoptionPopup() { window.open("./menuEditOptionPopup", "", "width=400, height=800, left=100, top=50"); }
</script>
...
<form method="post" enctype="multipart/form-data">
	...
	<p>메뉴명: <input type="text"></p>
	<p>가격: <input type="text"></p>
	<ul>
		<li>제품구성</li>
	</ul>
	...
	<ul>
		<li>
			<input type="button" value="추가옵션 등록" id="btnOpen">
			<div id="optionmodal">
				<div id="content">
					<input type='button' value='X' class="optionclosept" id="optionbtnClose"/>
					<p>메뉴옵션 등록</p>
					<table>
						<tr>
							<td><label>사이즈 옵션:</label></td>
							<td><input type="text" id="basic_option"/></td>
						</tr>
						<tr>
							<td><label>가격 입력:</label></td>
							<td><input type="number" id="basic_price" /></td>
						</tr>
					</table>
...
<!-- -------------------------------------추가옵션 등록 구간-------------------------------------------------->					
					...
					<input type="button" value="추가옵션입력창 열기" Id="addopbtn" onclick="ShowHide(this)"/>
					<script>
						function ShowHide(self) {
							var target = document.getElementById("addoption");
					...
					<div id = "addoption" style="display: none;">
						...
						<table>
							<tr>
								...
								<td><input type="text" id="side_option" /></td>
							</tr>
							<tr>
								<td><label>가격 입력:</label></td>
								<td><input type="number" id="side_price" /></td>
							</tr>
						</table>
...
<!-- ----------------------------------------------------------------------------------------------------->
					...
					<script>
						const printbasic_optionName = () => {
							...
							basicP.innerHTML = basic_option + basic_price + "원" + "<input type='button' value='삭제' onclick='remove(this)'>";
						...
						const printside_optionName = () => {
							...
							sideP.innerHTML = side_option + side_price + "원" + "<input type='button' value='삭제' onclick='del(this)'>";
					...
					<table border= '1'>
						<tr>
							<th>
								<div id="boList">사이즈 리스트</div>
							</th>
						</tr>
						<tr>
							<th>
								<div id="sideList">추가 옵션 리스트</div>
							</th>
						</tr>
					</table>
